...
const SocialFeed = () => {
  const allPosts = [
    ...
    {
      id: 2,
      post: "Tech Stocks Rally Continues",
      user: "Sarah",
      likes: 15,
      comments: [],
      liked: false,
    ...
    {
      id: 6,
      post: "SPX Technical Analysis shows bullish pattern",
      user: "Robert",
      likes: 32,
      comments: [],
      liked: false,
    ...
    {
      id: 7,
      post: "Oil prices surge amid geopolitical tensions",
      user: "Emma",
      likes: 45,
      comments: [],
      liked: false,
    ...
    {
      id: 8,
      post: "Tesla announces new factory location",
      user: "David",
      likes: 67,
      comments: [],
      liked: false,
    ...
    {
      id: 9,
      post: "Gold reaches 6-month high",
      user: "Sophie",
      likes: 28,
      comments: [],
      liked: false,
    ...
    {
      id: 10,
      post: "JPMorgan upgrades tech sector",
      user: "James",
      likes: 41,
      comments: [],
      liked: false,
    ...
    {
      id: 11,
      post: "NFT market shows signs of recovery",
      user: "Linda",
      likes: 19,
      comments: [],
      liked: false,
    ...
    {
      id: 12,
      post: "Real estate sector outlook for 2024",
      user: "Peter",
      likes: 23,
      comments: [],
      liked: false,
    ...
    {
      id: 13,
      post: "AI stocks continue to outperform",
      user: "Anna",
      likes: 56,
      comments: [],
      liked: false,
    ...
    {
      id: 14,
      post: "New crypto regulations announced",
      user: "Chris",
      likes: 34,
      comments: [],
      liked: false,
    ...
    {
      id: 15,
      post: "Small caps showing momentum",
      user: "Maria",
      likes: 29,
      comments: [],
      liked: false,
      ...
      <div className="max-w-3xl mx-auto p-6 space-y-6">
        ...
        <div className="grid gap-6">
          {filteredPosts.slice(0, visiblePosts).map((post) => (
            <Card
              key={post.id}
              className="w-full bg-white/90 backdrop-blur-sm shadow-md hover:shadow-lg transition-shadow duration-300 border-gray-200"
            >
              <CardHeader>
